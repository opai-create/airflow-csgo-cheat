...
public:
  // default ctor/dtor.
  __forceinline c_address( ): m_addr{ } { };
  __forceinline ~c_address( ){ };

  // ctors.
  __forceinline c_address( uintptr_t a ): m_addr{ a }
  {
  }
  __forceinline c_address( const void* a ): m_addr{ ( uintptr_t )a }
  {
  }
