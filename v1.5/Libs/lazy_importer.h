...
#define LAZY_IMPORTER_KHASH( str ) ::li::detail::khash( str, ::li::detail::khash_impl( __TIME__ __DATE__ LAZY_IMPORTER_STRINGIZE_EXPAND( __LINE__ ) LAZY_IMPORTER_STRINGIZE_EXPAND( __COUNTER__ ), 2166136261 ) )
...
namespace li
{
  namespace detail
  {
    ...
    {
      return static_cast< unsigned int >( ( value ^ ( ( CaseSensitive && c >= 'A' && c <= 'Z' ) ? ( c | ( 1 << 5 ) ) : c ) ) * static_cast< unsigned long long >( 16777619 ) );
    }
