...
FT_BEGIN_HEADER
   ...
   *     with weights of [0x08 0x4D 0x56 0x4D 0x08] in 1/128th units.
   *
   *   FT_LCD_FILTER_LIGHT ::
   *     this is a boxy, normalized, and color-balanced three-tap filter with
   *     weights of [0x00 0x55 0x56 0x55 0x00] in 1/128th units.
   *
   ...
   *     uses them to specify the filter weights in 1/128th units.
   *
   * @return:
   *   FreeType error code.  0~means success.
   *
