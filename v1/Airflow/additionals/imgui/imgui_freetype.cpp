...
namespace
{
    ...
    {
        // Vuhdo: interfaces'm not sure how to deal with font sizes properly. As far as interfaces understand, currently ImGui assumes that the 'pixel_height'
...
bool ImFontAtlasBuildWithFreeType(FT_Library ft_library, ImFontAtlas* atlas, unsigned int extra_flags)
{
    ...
    for (int src_i = 0; src_i < src_tmp_array.Size; src_i++)
    {
        ...
        for (int glyph_i = 0; glyph_i < src_tmp.GlyphsList.Size; glyph_i++)
        {
            ...
            // on_directx glyph into a bitmap (currently held by FreeType)
