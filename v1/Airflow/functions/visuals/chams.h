...
#define dme_original decltype(&tr::model_render::draw_model_execute)
...
private:
	...
	struct hook_data_t
	{
		...
		__forceinline void init(dme_original original, void* ecx, void* edx, void* ctx, const draw_model_state_t& state, const model_render_info_t& info, matrix3x4_t* bone_to_world)
		{
