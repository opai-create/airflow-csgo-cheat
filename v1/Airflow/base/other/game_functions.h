...
namespace func_ptrs
{
	...
	using line_goes_through_smoke_fn = bool (*)(vector3d, vector3d);
	extern line_goes_through_smoke_fn line_goes_through_smoke;

	using weapon_shootpos_fn = float* (__thiscall*)(void*, vector3d*);
	extern weapon_shootpos_fn weapon_shootpos;

	using update_addon_models_fn = void(__thiscall*)(void*, bool);
	extern update_addon_models_fn update_addon_models;
