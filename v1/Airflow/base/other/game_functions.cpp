...
namespace func_ptrs
{
	...
	modify_body_yaw_fn modify_body_yaw{};
	...
	line_goes_through_smoke_fn line_goes_through_smoke{};
	weapon_shootpos_fn weapon_shootpos{};
	update_addon_models_fn update_addon_models{};
	...
	__forceinline void init()
	{
		...
		modify_body_yaw = patterns::modify_body_yaw.as< modify_body_yaw_fn >();
		...
		line_goes_through_smoke = patterns::line_goes_through_smoke.as< line_goes_through_smoke_fn >();
		weapon_shootpos = patterns::weapon_shootpos.as< weapon_shootpos_fn >();
		update_addon_models = patterns::update_addon_models.as< update_addon_models_fn >();
