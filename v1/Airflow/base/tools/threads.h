...
public:
    ...
    void init()
    {
        allocate_thread_id = (allocate_thread_id_fn)GetProcAddress(modules::tier0, xor_c("AllocateThreadID"));
        free_thread_id = (free_thread_id_fn)GetProcAddress(modules::tier0, xor_c("FreeThreadID"));
...
inline std::unique_ptr< c_thread_pool > g_thread_pool{};