...
namespace offsets
{
	...
	inline uintptr_t m_bInitialized{};
	inline uintptr_t m_hPlayer{};
	inline uintptr_t m_bStrafing{};
	inline uintptr_t m_flModelScale{};
	inline uintptr_t m_nPersonaDataPublicLevel{};
	inline uintptr_t m_angRotation{};
	inline uintptr_t m_bDucking{};
...
public:
	...
	bool hook_prop(uint32_t table_name, uint32_t prop_name, recv_var_proxy_fn fn, recv_var_proxy_fn& orig, bool store = false);
};
