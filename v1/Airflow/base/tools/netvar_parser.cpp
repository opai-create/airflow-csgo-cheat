...
namespace netvars
{
	__forceinline void init()
	{
		...
		offsets::m_iShotsFired = g_netvar_manager->get_offset(__fnva1("DT_CSPlayer"), __fnva1("m_iShotsFired"));
		...
		offsets::m_flModelScale = g_netvar_manager->get_offset(__fnva1("DT_BaseAnimating"), __fnva1("m_flModelScale"));
		...
		offsets::m_angRotation = g_netvar_manager->get_offset(__fnva1("DT_BaseEntity"), __fnva1("m_angRotation"));
		...
		offsets::m_iItemIDLow = g_netvar_manager->get_offset(__fnva1("DT_EconEntity"), __fnva1("m_iItemIDLow"));
		...
		offsets::m_nPersonaDataPublicLevel = g_netvar_manager->get_offset(__fnva1("DT_CSPlayerResource"), __fnva1("m_nPersonaDataPublicLevel"));
		...
		offsets::m_bInitialized = g_netvar_manager->get_offset(__fnva1("DT_WearableItem"), __fnva1("m_bInitialized"));

		offsets::m_hPlayer = g_netvar_manager->get_offset(__fnva1("DT_CSRagdoll"), __fnva1("m_hPlayer"));

		offsets::m_ubEFNoInterpParity = g_netvar_manager->get_offset(__fnva1("DT_BasePlayer"), __fnva1("m_ubEFNoInterpParity"));
		offsets::m_ubEFNoInterpParityOld = offsets::m_ubEFNoInterpParity + 1;
	}
}